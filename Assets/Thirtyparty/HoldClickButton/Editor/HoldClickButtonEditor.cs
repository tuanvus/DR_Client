...
namespace BetterButtonsEditor
{
    ...
    public class HoldClickButtonEditor : ButtonEditor
    {
        ...
        private SerializedProperty holdDurationProperty;


        protected override void OnEnable()
        {
            eventProperty = serializedObject.FindProperty("onHoldClick");
            holdDurationProperty = serializedObject.FindProperty("holdDuration");   
            base.OnEnable();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(holdDurationProperty, new GUIContent("Hold Duration"));
