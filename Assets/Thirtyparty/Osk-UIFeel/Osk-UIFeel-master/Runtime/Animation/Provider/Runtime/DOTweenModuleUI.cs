...
namespace OSK
{
	public static class DOTweenModuleUI
    {
        ...
        public static DG.Tweening.Sequence DOGradientColor(this Image target, Gradient gradient, float duration)
        {
        ...
        /// <param name="duration">The duration of the tween</param>
        /// <param name="snapping">If TRUE the tween will smoothly snap all values to integers</param>
        public static DG.Tweening.Sequence DOJumpAnchorPos(this RectTransform target, Vector2 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
        {
